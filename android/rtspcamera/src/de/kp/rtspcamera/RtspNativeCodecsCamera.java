...
//	private int SERVER_PORT = 8080;
	...
	private CameraMediaCodec  mCameraMediaCodec = null ;
	...
	SurfaceHolder.Callback surfaceCallback = new SurfaceHolder.Callback() {
		...
		public void surfaceChanged(SurfaceHolder holder, int format, int w, int h) {
			Log.d(TAG, "surfaceChanged");
		        if(mCameraMediaCodec == null)
                        {
                            mCameraMediaCodec = new CameraMediaCodec(null,null,null) ;
                        }
                        mCameraMediaCodec.internalStartPlay(previewHolder) ;
	...
	private void initializePreview(int width, int height) {
		...
		if (camera != null && previewHolder.getSurface() != null) {
			try {
				...
				camera.setPreviewDisplay(mCameraMediaCodec.getfakeSurface());
